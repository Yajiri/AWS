...
aws s3 cp DeleteFromDDB.zip s3://sentismotest
aws s3 cp DeleteFromEB.zip s3://sentismotest
aws s3 cp ReadFromDDB.zip s3://sentismotest
aws s3 cp WriteToDDB.zip s3://sentismotest
aws s3 cp WriteToEB.zip s3://sentismotest
